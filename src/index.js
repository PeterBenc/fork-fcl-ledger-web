    ...
    <Router>
      <Wrapper onClick={handleCancel}>
        <Inner onClick={e => e.stopPropagation()}>
          ...
          <Switch>
            <Route path="/local/showkey" component={props => <ShowKey {...props} network="local" />} exact />
            <Route path="/canarynet/showkey" component={props => <ShowKey {...props} network="canarynet" />} exact />
            <Route path="/testnet/showkey" component={props => <ShowKey {...props} network="testnet" />} exact />
            <Route path="/mainnet/showkey" component={props => <ShowKey {...props} network="mainnet" />} exact />
